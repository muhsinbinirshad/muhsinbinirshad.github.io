export default function SkillCard({ category, skills }) {
  if (category === "ML Models") return null;
  ...
  return (
    <div className="group flex items-start lg:hover:dark:text-white lg:p-4 rounded-lg transition-all ease-out text-gray-800 dark:text-gray-400 text-base lg:hover:bg-opacity-75 lg:hover:bg-primary-900 hover:rounded-3xl">
