  ...
  return (
    ...
    >
      ...
      <div className={highlight ? "w-full mt-4 lg:mt-0" : "w-full mt-4"}>
        ...
        {description && description.startsWith('[Work in Progress]') && (
          <span className="inline-block mb-2 px-3 py-1 rounded-full bg-primary-600 text-white text-xs font-semibold tracking-wider shadow-md">
            Development in Progress
          </span>
        )}
        <p className="mt-4 leading-relaxed text-gray-600 dark:text-gray-300">
          {description && description.replace(/^\[Work in Progress\]\s*/, '')}
        </p>
