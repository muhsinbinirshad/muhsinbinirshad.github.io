        ...
        <div className="max-w-6xl mx-auto px-6">
          {posts.length === 0 ? (
            <div className="text-center py-24 text-gray-400">
              <svg className="mx-auto mb-4 w-16 h-16 text-primary-500/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-500">Check back soon for new cybersecurity insights and tutorials!</p>
            </div>
          ) : (
            <motion.div
